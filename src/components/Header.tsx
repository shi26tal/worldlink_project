...
const Header = ({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 lg:left-64 z-50 bg-[#F8F9FC] border-b border-gray-200 px-4 md:px-6 py-4">
